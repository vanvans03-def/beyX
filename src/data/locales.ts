export const locales = {
    TH: {
        ...
        "rankings.rule": "5 / 3 / 2 / 1 คะแนน สำหรับอันดับ 1–4",
        "rankings.monthly": "รายเดือน",
        "rankings.yearly": "รายปี",
        "rankings.winrate": "วินเรท",
        "rankings.winrate_rule": "ชนะ ÷ จำนวนเกมที่แข่งทั้งหมด × 100 (เดือนที่เลือก)",
    ...
    EN: {
        ...
        "rankings.rule": "5 / 3 / 2 / 1 points for placements 1–4",
        "rankings.monthly": "Monthly",
        "rankings.yearly": "Yearly",
        "rankings.winrate": "Win Rate",
        "rankings.winrate_rule": "Wins ÷ total matches played × 100 (selected month)",
