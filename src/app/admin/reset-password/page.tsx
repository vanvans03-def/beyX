        ...
        <div className="min-h-screen bg-[#050505] text-white p-6 md:p-8 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="w-full max-w-lg space-y-8 relative z-10">
                ...
                <div className="flex items-center gap-4">
                    <button
                        onClick={() => router.back()}
                        className="w-12 h-12 bg-white/5 hover:bg-white/10 rounded-xl flex items-center justify-center border border-white/10 transition-all hover:border-white/20"
                    >
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-0.5 text-sm">Update your account password</p>
                    </div>
                </div>

                {/* Card */}
                <div className="bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl backdrop-blur-sm space-y-6">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex gap-3 pt-2">
                            <button
                                type="button"
                                onClick={() => router.back()}
                                className="flex-1 bg-white/5 hover:bg-white/10 text-white font-medium py-3 rounded-xl transition-all border border-white/10 hover:border-white/20 uppercase tracking-wide text-sm"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="flex-1 bg-primary hover:bg-primary/90 text-black font-bold py-3 rounded-xl transition-all shadow-lg shadow-primary/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 uppercase tracking-wide text-sm"
                            >
                                {loading ? (
                                    <>
