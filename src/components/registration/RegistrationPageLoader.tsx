...
export default function RegistrationPageLoader({ tournamentId }: { tournamentId: string }) {
    ...
    return <RealtimeTournamentWrapper initialTournament={tournament} tournamentId={tournamentId} />;
}
